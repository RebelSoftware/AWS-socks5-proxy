...
- **Idle shutdown:** Configurable (default 60 min, auto-saves costs)
...
**Savings:** No minimum — pay only when running; auto-shutdown after configured idle timeout.
...
Auto-shutdown after the configured idle timeout (default 60 min). 
...
Yes — see [serjs/go-socks5-proxy](https://github.com/serjs/go-socks5-proxy) for config options.
